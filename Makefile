...
CFLAGS  = -std=c99 -Wall -Wextra -pedantic -Werror -O2 \
          ...
          -Isrc -Isrc/fe -Isrc/ir -Isrc/amdgpu -Isrc/tensix -Isrc/runtime
LDFLAGS = -pie
LIBS    = -lm
...
SOURCES = src/main.c \
          ...
          src/amdgpu/amd_rplan.c src/amdgpu/isel.c src/amdgpu/emit.c src/amdgpu/encode.c src/amdgpu/enc_tab.c src/amdgpu/sched.c src/amdgpu/verify.c \
...
COBJS   = src/ir/bir.o src/ir/bir_print.o src/ir/bir_lower.o src/ir/bir_mem2reg.o src/ir/bir_cfold.o src/ir/bir_dce.o \
          src/amdgpu/amd_rplan.o src/amdgpu/encode.o src/amdgpu/enc_tab.o src/amdgpu/isel.o src/amdgpu/emit.o src/amdgpu/sched.o src/amdgpu/verify.o \
